...
public class RentalInfo {
    ...
    public String statement2 (Customer customer) {
    ...
    private RentalAmount customerRentals(Customer customer, HashMap<String, Movie> movies, RentalAmount rentalAmount) {
        for (MovieRental rental : customer.getRentals()) {
            ...
            BigDecimal thisAmount = calculateAmount(BigDecimal.valueOf(0), movie.getCode(), rental.getDays());
    ...
    private BigDecimal calculateAmount(BigDecimal thisAmount, String movieCode, int days) {
